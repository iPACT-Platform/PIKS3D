!  NOTE: Sun May 14 09:35:33 2017
!  This serves as benchmark code for singleSphere flow using Minh's code
!  Different discrete velocity has been included
!  The parameters here needs to be dicussed with Minh
!  
...
integer, parameter :: Ny = 100 !number of point half height channel, including two end
integer, parameter :: Nx = Ny*2  !length of the channel
integer, parameter :: Nz = Ny
...
integer, parameter :: obstX = (NX+1)/2.0
...
integer, parameter :: iteration_max=10000000,iteration_min=100,interval=100
...
!=======================================================================
integer, parameter :: Nc_fundamental=4 !Number of fundamental molecular velocity
...
! half-range GH8
xi(1) = 0.1337764469960676271554406d0         !fundamental abscissae
xi(2) = 0.6243246901871899710746947d0
xi(3) = 0.1342537825644992283666126d1 
xi(4) = 0.2262664477010361954334673d1 
weight1D(1) = 0.3253029997569190434524823d0/dsqrt(PI)    !fundamental weighting
...
!xi(1) =     5.297864393185112986d-02
!xi(2) =     2.673983721677653524d-01
!xi(3) =     6.163028841823998683d-01
!xi(4) =     1.064246312116224003d+00
!xi(5) =     1.588855862270055264d+00
!xi(6) =     2.183921153095858436d+00
!xi(7) =     2.863133883708075089d+00
!xi(8) =     3.686007162724397102d+00

!weight1D(1) =     7.566300718342849896d-02
!weight1D(2) =     1.513894166189734825d-01
!weight1D(3) =     1.556900326896759612d-01
!weight1D(4) =     8.883068100100477427d-02
!weight1D(5) =     2.528365401139678892d-02
!weight1D(6) =     3.028533438703043430d-03
!weight1D(7) =     1.140022060541547879d-04
!weight1D(8) =     6.728507633561610041d-07
